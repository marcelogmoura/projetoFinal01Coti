...
<body class="bg-secondary">
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 custom-bg"> 
            ...
            <h2 class="text-center mb-4">. Edição de Contatos .</h2>
            <p class="text-center">Altere o(s) campo(s) abaixo.</p>
            ...
            <form id="formEdicao" method="post" action="contatos-edicao-post">
                <div class="mb-2">
                    <label for="nome" class="form-label"> <i class="bi bi-person"></i> Nome:</label>
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome do contato" value="${nome}">
                </div>
                <div class="mb-2">
                    <label for="Email" class="form-label"> <i class="bi bi-mailbox"></i> Email:</label>
                    <input type="text" class="form-control" id="email" name="email" placeholder="Email do contato" value="${email}">
                </div>
                <div class="mb-2">
